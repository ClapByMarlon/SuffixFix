...
Ein LabyMod 3 Addon für Minecraft 1.8.9.

**Beschreibung:** Spieler mit Suffix aus der Verkauf-zone gekickt.
...
1. Lade die neueste `.jar` aus den GitHub Releases herunter.
